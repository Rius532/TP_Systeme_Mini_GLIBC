...
all: app mini_touch mini_cp mini_echo mini_cat mini_head mini_tail mini_clean
...
fclean: clean
	rm -f app.exe mini_touch mini_cp mini_cat mini_echo mini_cat mini_head mini_tail mini_clean
